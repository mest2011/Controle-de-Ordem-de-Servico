...
public class User implements Serializable {
    ...
    public void setPasswordLastChanged(Date passwordLastChanged) {
        Date oldPasswordLastChanged = this.passwordLastChanged;
        this.passwordLastChanged = passwordLastChanged;
        changeSupport.firePropertyChange("passwordLastChanged", oldPasswordLastChanged, passwordLastChanged);
    }
    ...
    public void setPasswordLifetime(Short passwordLifetime) {
        Short oldPasswordLifetime = this.passwordLifetime;
        this.passwordLifetime = passwordLifetime;
        changeSupport.firePropertyChange("passwordLifetime", oldPasswordLifetime, passwordLifetime);
    }
    ...
    public void setAccountLocked(String accountLocked) {
        String oldAccountLocked = this.accountLocked;
        this.accountLocked = accountLocked;
        changeSupport.firePropertyChange("accountLocked", oldAccountLocked, accountLocked);
    }
    ...
    public String toString() {
        return "controleos.User[ userPK=" + userPK + " ]";
    }
