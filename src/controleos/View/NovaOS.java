 ...
 */
package controleos.View;

import controleos.Controller.NewOS;
import controleos.Controller.ValidaSeCampoEhSoNumero;
import controleos.DAO.NewOsDAO;
import controleos.NovoCliente;
...
public class NovaOS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSeachCli = new javax.swing.JButton();
        ...
        btnSeachCli.setText("Procurar cliente");
        btnSeachCli.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSeachCliActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        ...
                                        .addComponent(btnSeachCli, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnSeachCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeachCliActionPerformed
        if(!txtIdCli.getText().equals(null)){
        if(new ValidaSeCampoEhSoNumero().ValidaCampo(txtIdCli.getText())){
            if(txtCPF.getText().equals(null)){
            if(new ValidaSeCampoEhSoNumero().ValidaCampo(txtCPF.getText())){
                
            }
                
                JOptionPane.showMessageDialog(null, "Insira apenas numeros no campo CPF do Cliente!");
            }
            JOptionPane.showMessageDialog(null, "Insira apenas numeros no campo CÓDIGO do Cliente!");
        }
        }   
        NewOS newos = new NewOS();
                newos.setIdCli(Integer.parseInt(txtIdCli.getText()));
                newos.setNomeCli(txtNomeCli.getName());
                newos.setCpf(Integer.parseInt(txtCPF.getText()));
        if(!txtIdCli.getText().equals(null)){
    ...
    }//GEN-LAST:event_btnSeachCliActionPerformed
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
            ...
            NewOS newos = new NewOS();
            newos.setModel(txtModel.getText());
            newos.setSerialNumber(txtSerialNumber.getText());
            newos.setObsCar(EdPObsCar.getText());
            if(txtIdCli.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Escolha um cliente para cadastrar a OS!");
            }
            newos.setIdCli(Integer.parseInt(txtIdCli.getText()));
            newos.setNomeCli(txtNomeCli.getName());
        try {
            NewOsDAO newosdao = new NewOsDAO();
            newosdao.salvar(newos);
    ...
    private javax.swing.JButton btnSeachCli;
